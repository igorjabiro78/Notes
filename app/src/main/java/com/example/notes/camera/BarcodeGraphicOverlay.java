 ...
 */
package com.example.notes.camera;
 ...
 * </ol>
 */
public class BarcodeGraphicOverlay<T extends BarcodeGraphicOverlay.Graphic> extends View {
    ...
    public static abstract class Graphic {
        ...
        public Graphic(BarcodeGraphicOverlay overlay) {
            mOverlay = overlay;
        }
    ...
    public BarcodeGraphicOverlay(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
